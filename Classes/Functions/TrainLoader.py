...
class TrainLoader():
    ...
    def load(self,train_dict,relation_dict,line_dict,way_dict,node_dict,nodeTraffic_dict,simulation_speed):
        if self.delay!=0:
            if self.delay<0:
                self.delay=0
            if self.delay>0:
            ...
            for name in self.name_dict:
                ...
                if len(nodeTraffic_dict[finalStopId]) >0:
                    ...
                    testLine1 = info[0]
                    testLine2 = info[1]
                    train = Train(13, 1.7, testLine1, testLine2, relation_dict, line_dict, way_dict, node_dict,uuid.uuid4())
