...
class Train:
    def __init__(self, maxVel,maxAcceleration,lineName1,lineName2,relation_dict,line_dict,way_dict,node_dict, idObject ):
        ...
        self.particle = Particle(Vector(nodeCurrent['x'],nodeCurrent['y']), Vector(0,0), self.idObject)
